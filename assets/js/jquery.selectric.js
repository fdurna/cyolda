  ...
  Selectric.prototype = {
      ...
      $.each(items, function (i, elm) {
        if (elm.label !== undefined) {
          markup += _this.utils.format(
            ...
            _this.utils.arrayToClassname([_this.classes.group, elm.groupDisabled ? 'disabled' : '', elm.element.prop('class')]),
    ...
    getItemMarkup: function (index, itemData) {
      ...
      return _this.utils.format(
        ...
        $.isFunction(itemBuilder) ? _this.utils.format(itemBuilder(itemData, this.$element, index), itemData) : _this.utils.format(itemBuilder, filteredItemData)
      );
    },
